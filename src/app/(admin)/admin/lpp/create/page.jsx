...
export default function CreateLPPPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    description: "",
    chairman_name: "",
    chairman_position: "Direktur Utama",
    chairman_instagram: "",
    chairman_image: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await supabase.from("lpp").insert([
      {
    ...
    if (error) {
      alert("Gagal menyimpan LPP: " + error.message);
      setLoading(false);
    } else {
      alert("LPP berhasil ditambahkan!");
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-sm border border-gray-100">
      <div className="mb-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">Tambah LPP Baru</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="pt-4">
          ...
          >
            {loading ? "Menyimpan..." : "SIMPAN LEMBAGA"}
          </button>
        </div>
